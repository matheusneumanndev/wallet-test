        ...
        child: SingleChildScrollView(
          child: PaperForm(
            ...
            actionButtons: <Widget>[
              ElevatedButton(
                child: const Text('Transferir agora'),
                style: ButtonStyle(backgroundColor: MaterialStateProperty.all(const Color(0xff1a0441))),
                onPressed: () => onSubmit(
            ...
            children: <Widget>[
              ...
              PaperInput(
                ...
                hintText: 'Endereço da carteira',
              ),
              SizedBox(height: 30,),
              PaperInput(
                controller: amountController,
                labelText: 'Quantidade',
                hintText: 'Quantidade a enviar',
              ),
            ],
          ),
        ),
