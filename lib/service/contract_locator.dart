...
class ContractLocator {
  ...
  static Future<ContractService> createInstance(
    ...
    final contractEcoin = await ContractParser.fromAssets(
        'ECOIN.json', networkConfig.ecoinAddress);

    final contractWBNB = await ContractParser.fromAssets(
        'WBNB.json', networkConfig.wbnbAddress);

    return ContractService(client, contractEcoin, contractWBNB);
  }
}
